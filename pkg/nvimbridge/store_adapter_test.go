...
func TestPluginDBStoreAdapter_Create(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Get(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Update(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Upsert(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Delete(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_List(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_ListByCategory(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_ListByTag(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Exists(t *testing.T) {
	mock := NewMockPluginDataStore()
	adapter := NewPluginDBStoreAdapter(mock)
...
func TestPluginDBStoreAdapter_Close(t *testing.T) {
	mock := NewMockPluginDataStore()
	...
	adapter2 := NewPluginDBStoreAdapterOwned(mock2)
	err = adapter2.Close()
	if err != nil {
		t.Fatalf("Close failed: %v", err)
	}
...
func TestNvimPluginStore_ThroughInterface(t *testing.T) {
	...
	retrieved, err := ps.Get("telescope")
	if err != nil {
	...
	exists, err := ps.Exists("telescope")
	if err != nil {
	...
	err = ps.Delete("telescope")
	if err != nil {
		t.Fatalf("Delete through interface failed: %v", err)
	}

	exists, _ = ps.Exists("telescope")
	if exists {
...
func TestPluginStore_Swappability(t *testing.T) {
	...
	testLocalStore := func(ps NvimPluginStore, name string) {
		...
		// Get
		retrieved, err := ps.Get("test-plugin")
		if err != nil {
		...
		// Delete
		if err := ps.Delete("test-plugin"); err != nil {
...
//
// These tests verify the full stack: PluginDBStoreAdapter -> DataStore -> SQLite
...
func TestIntegration_CreatePlugin_VerifyWithSQL(t *testing.T) {
	...
	adapter := NewPluginDBStoreAdapter(testDB)
